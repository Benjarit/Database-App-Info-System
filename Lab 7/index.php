		...
		<body>
			...
			if($_SERVER["HTTPS"] != "on")
			{
				...
				exit();
					...
					$conn = mysqli_connect('localhost','root','Bigboy3362','lab7');
					if (!$conn){
						...
						if(isset($_POST['register'])){
							...
							$sql = "INSERT INTO user(username,hashed_password) VALUES (?,?)";
							if($stmt = mysqli_prepare($conn, $sql)){
								mysqli_stmt_bind_param($stmt, "ss", $userDataName,$pwhash) or die("bind param");
